...
const required = [
  ...
  'apps/docs/src/content/docs/worker/multi-tab-orchestration.md',
  'apps/docs/src/content/docs/worker/cross-engine-grids.md',
  'apps/docs/src/content/docs/operations/manual-action-alerts.md',
  'apps/docs/src/content/docs/security/sso-sessions.md',
  'apps/docs/src/content/docs/security/audit-export-merkle.md',
  'apps/docs/src/content/docs/data/postgres-persistence.md',
